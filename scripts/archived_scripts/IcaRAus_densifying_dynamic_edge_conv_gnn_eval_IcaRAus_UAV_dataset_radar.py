...
config_label = "IcaRAus_uav_radar_densifying_deep_dynamic_edge_conv_grid_{}fh_rt_gt_no_rmv_occlusion_pts_0_25_eps_10_min_20_sub_70_fov_1_0_accu_subsample".format(num_frames_history)

#model information
model_config_path = "/home/david/Documents/odometry/submodules/mmwave_model_integrator/configs/IcaRAus_gnn/IcaRAus_densifying_deep_dynamic_edge_conv_gnn_50fh_no_rmv_occlusion_pts_0_25_eps_10_min_20_sub_70_fov_1_0_accu_subsample.py"
model_state_dict_path = "/home/david/Downloads/IcaRAus_DensifyingDeepDynamicEdgeConvGnn_grid_50fh_no_rmv_occlusion_pts_0_25_eps_10_min_20_sub_70_fov_1_0_accu_subsample.pth"
...
def analyze_dataset(
    ...
    runner = GNNRunner(
        ...
        cuda_device="cpu",#"cuda:0" if torch.cuda.is_available() else "cpu",
        edge_radius=10.0,
