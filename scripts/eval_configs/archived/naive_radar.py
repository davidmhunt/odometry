...
def get_test_bench(dataset, map_handler, model_info=None, **kwargs):
    """Initializes and returns a NaiveRadarBaselineTB for Naive Radar evaluation.

    Args:
        dataset (CpslDS): The dataset object to be evaluated.
        map_handler (MapHandler): The map handler for localization.
        model_info (dict, optional): Ignored for this evaluation mode.

    Returns:
        NaiveRadarBaselineTB: A fully initialized test bench for evaluation.
    """
