...
def get_test_bench(dataset, map_handler, model_info=None, num_frames_history=50, normalize_frames=True):
    """Initializes and returns a TemporalDensityPCIntegratorTB for IcaRAus GNN UAV evaluation.
    ...
    Args:
        ...
        num_frames_history (int, optional): Number of frames for point cloud accumulation. 
            Defaults to 50.
        normalize_frames (bool, optional): Whether to normalize individual radar frames. 
            Defaults to True.

    Returns:
        TemporalDensityPCIntegratorTB: A fully initialized test bench for evaluation.
    """
    
    if model_info is None:
        raise ValueError("model_info is required for icaraus_gnn_uav evaluation")
