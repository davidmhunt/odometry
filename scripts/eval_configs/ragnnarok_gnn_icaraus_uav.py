...
def get_test_bench(dataset, map_handler, model_info=None, num_frames_history=50, normalize_frames=True):
    """Initializes and returns a TemporalDensityPCIntegratorTB for RaGNNarok GNN on IcaRAus UAV evaluation.
    """
    
    if model_info is None:
        raise ValueError("model_info is required for ragnnarok_gnn_icaraus_uav evaluation")
