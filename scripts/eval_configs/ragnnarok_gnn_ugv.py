...
def get_test_bench(dataset, map_handler, model_info=None, **kwargs):
    """Initializes and returns a RaGNNPointCloudIntegratorTB for RaGNNarok GNN UGV evaluation.
    """
    
    if model_info is None:
        raise ValueError("model_info is required for ragnnarok_gnn_ugv evaluation")
