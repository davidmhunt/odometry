...
def get_test_bench(dataset, map_handler, model_dataset_generator, **kwargs):
    """Initializes and returns a RaGNNPointCloudIntegratorTB for RaGNNarok GNN UGV dataset generation.
    ...
    Returns:
        RaGNNPointCloudIntegratorTB: A fully initialized test bench for dataset generation.
    """
