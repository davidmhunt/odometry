...
DEFAULT_MAP_DIRECTORY = "/data/IcaRAus/maps"
DEFAULT_GENERATED_DATASETS_PATH = "/data/IcaRAus/generated_datasets"
...
def generate_ds_fold(config_file, num_frames_history=50, normalize_frames=True):
    ...
    Args:
        config_file (str): Filename of the dataset configuration (e.g., 'IcaRAus_ds_train_f1.yaml').
    ...
    for config_key in datasets_to_test.keys():
        ...
        for file_name in folder_config["datasets"]:
            ...
            ds_params = {
                ...
                "radar_pc_folder": folder_config.get("radar_pc_folder", "radar_combined_pc"),
            ...
            # Start Heading/Pose logic (Hardcoded exceptions from original script)
...
if __name__ == "__main__":
    ...
    fold_configs = [
        "IcaRAus_ds_train_f1.yaml",
        "IcaRAus_ds_train_f2.yaml",
        "IcaRAus_ds_train_f3.yaml",
        "IcaRAus_ds_train_f4.yaml",
        "IcaRAus_ds_train_f5.yaml",
        "IcaRAus_ds_train_f6.yaml",
    ]
