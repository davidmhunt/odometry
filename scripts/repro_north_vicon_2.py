...
# Import necessary modules from the original script
...
def generate_gnn_dataset(
    ...
    print(f"DEBUG: Processing {file_name} in folder {folder_name} with map {map_file}")
    ...
    print("DEBUG: Dataset run completed successfully")

if __name__ == "__main__":
    folder_name = "NORTH_VICON"
    file_name = "north_vicon_2"
    map_name = "north_vicon_1.yaml"
    config_label = "IcaRAus_ugv_IcaRAus_ds_f1"
    results_parent_folder = "repro_results"
    num_frames_history = 50
    normalize_frames = True
